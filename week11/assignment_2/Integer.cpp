...
Number *Integer::add(Number * num) {
    ...
    if (num->types() == INTEGER) {
		...
		int result = other->val() + this->value;
		delete(other);
		delete(this);
		...
		float result = other->val() + this->value;
		delete(other);
		delete(this);
		...
		double a = other->real() + this->value;
		double b = other->imag(); 
...
Number *Integer::sub(Number * num) {
     ...
     */if(num->types() == INTEGER) {
		Integer *other = dynamic_cast<Integer*>(num);
		int result = this->value - other->val() ;
		delete(other);
		delete(this);
		return new Integer(result);
	}else if(num->types() == FLOAT) {
		Float *other = dynamic_cast<Float*>(num);
		float result = this->value - other->val();
		delete(other);
		delete(this);
		return new Float(result);
	}else if(num->types() == COMPLEX) {
		Complex *other = dynamic_cast<Complex*>(num);
		double a = this->value - other->real();
		double b = other->imag() ;
		delete(other);
		delete(this);
		return new Complex(a,b);
...
Number *Integer::mul(Number * num) {
	...
	if(num->types() == INTEGER){
		...
		Complex *other = dynamic_cast<Complex*>(num);
		double a = other->real() * this->value;	
		double b = other->imag() * this->value;
		delete(other);
		delete(this);
		return new Complex(a,b);
	}
